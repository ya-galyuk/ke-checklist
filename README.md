...
# UA     
 ...
 - [Вимоги до дня](#вимоги-до-дня)    
	 - [Зразок розкладу на день](#зразок-розкладу-на-день)
		 - [Початок розкладу для кожного дня](#початок-розкладу-для-кожного-дня)
		 - [Рядки](#рядки)
		 - [Стовпці](#стовпці)
 - [Вимоги до об'єкту предмета](#вимоги-до-об'єкту-предмета) 
...
## Загальні вимоги  
 ...
 1. Файл має бути розширення `.xlsx`.   
 2. **Не пустий** файл повинен зберігати структуру [початку розкладу для кожного дня](#Початок-розкладу-для-кожного-дня).   
    
    
## Вимоги до дня 
  
### Зразок розкладу на день  

![main_structure_day](img/main_structure_day.png) 
...
Якщо потрібно встановити для предмета особливу дату, або ж проміжок дат – скористайтесть одним з варіантів:
   1. (**з** _dd.mm.yyyy_)
   2. (**до** _dd.mm.yyyy_)
...
# RU
 ...
 - [Требования ко дню](#требования-ко-дню)
    - [Образец расписания на день](#образец-расписания-на-день)
